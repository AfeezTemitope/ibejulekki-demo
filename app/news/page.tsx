...
import { homepageNewsQuery } from '@/lib/queries'
...
// Fetch all news — more than homepage (up to 50)
...
const PLACEHOLDER_NEWS = [
  ...
  { _id:'n5', title:'Executive Chairman Commissions New Market Stalls at Akodo',              slug:{ current:'akodo-market-stalls-commissioning' },           category:'economy',        publishedAt:'2025-10-14T09:00:00Z', featured:false, summary:'Hon. Abdullahi Sesan Olowa commissions 120 new market stalls at Akodo market, boosting local trade and providing new livelihoods for residents.',                             coverImage:null },
  { _id:'n6', title:'Free Medical Outreach Reaches Over 2,000 Residents in Ibeju-Lekki',     slug:{ current:'free-medical-outreach-2025' },                  category:'health',         publishedAt:'2025-09-05T09:00:00Z', featured:false, summary:'The council's health department, in partnership with private hospitals, conducts a free medical outreach covering malaria, hypertension, diabetes, and eye care.',            coverImage:null },
  { _id:'n7', title:'Ibeju-Lekki Hosts Inter-Ward Security Summit',                           slug:{ current:'inter-ward-security-summit' },                  category:'security',       publishedAt:'2025-08-20T09:00:00Z', featured:false, summary:'Ward leaders, community heads, and security agencies gather at the council secretariat to align on a joint security framework for the local government area.',             coverImage:null },
  { _id:'n8', title:'Council Begins Distribution of Free JAMB Forms to SS3 Students',        slug:{ current:'free-jamb-forms-distribution' },                category:'education',      publishedAt:'2025-07-10T09:00:00Z', featured:false, summary:'Over 150 SS3 students across public schools in Ibeju-Lekki receive free JAMB registration forms as part of the chairman\'s education empowerment initiative.',           coverImage:null },
]
...
const CATEGORY_COLORS: Record<string, string> = {
  governance:'bg-[#0F3D2E] text-white', infrastructure:'bg-[#1A3A7A] text-white',
  health:'bg-emerald-700 text-white',    education:'bg-[#C89B3C] text-[#0A1F14]',
    ...
    <>
      ...
      <main className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-12 sm:py-16">
            ...
            >
              ...
              <div className="p-6 sm:p-8 flex flex-col justify-center">
                <div className="flex items-center gap-2 text-[10.5px] text-[#0A1F14]/40 mb-3">
                  ...
                  <span className={`text-[9.5px] font-bold uppercase tracking-[0.12em] px-2 py-0.5 rounded-full ${CATEGORY_COLORS[featured.category] ?? 'bg-[#C89B3C]/15 text-[#C89B3C]'}`}>
                    {CATEGORY_LABELS[featured.category] ?? featured.category}
                  </span>
                </div>
          ...
          {/* Empty state — only shows if somehow both fetch and placeholder fail */}
          {posts.length === 0 && (
            <div className="text-center py-20">
              <div className="text-[#0A1F14]/25 text-[14px]">No articles yet. Check back soon.</div>
            </div>
          )}
        </div>
      </main>
