...
const blogs = [
  {
    cat: 'Governance',
    d: 'Apr 17, 2026',
    t: 'LASG Set To Drive Local Government Development Plan (LGDP)',
    e: 'Conference 57 Chairman appreciates unified plan for accelerated growth across the 57 LGAs.',
    s: 'lgdp-conference',
    featured: true,
  },
  {
    cat: 'Infrastructure',
    d: 'Mar 01, 2026',
    t: 'Stakeholders\' Meeting on Gbadamosi Alo Street',
    e: 'A crucial meeting on the rehabilitation as part of ongoing infrastructural efforts.',
    s: 'gbadamosi-alo',
  },
  {
    cat: 'Community',
    d: 'Nov 30, 2025',
    t: 'Women Empowerment Program at Council Secretariat',
    e: 'A transformative program organised by students of Pan-Atlantic University.',
    s: 'women-empowerment',
  },
  {
    cat: 'Power',
    d: 'Nov 22, 2025',
    t: '33KV Overhead Power Line Rehabilitation Flag-off',
    e: 'The Executive Chairman led the official flag-off from Ibeju Long Bridge.',
    s: 'power-line',
  },
];
  ...
  return (
    <>
      ...
      <main className="overflow-hidden">
            ...
            <div className="grid lg:grid-cols-12 gap-16 items-center">
              <Reveal className="lg:col-span-5 order-2 lg:order-1">
                <div className="relative">
                  <div className="aspect-[4/5] bg-gradient-to-br from-forest via-moss to-forest rounded-2xl overflow-hidden relative">
                    <div className="absolute inset-0" style={{backgroundImage: 'radial-gradient(circle at 30% 40%, rgba(200,155,60,0.3), transparent 50%)'}}></div>
                    <div className="absolute inset-0 flex items-end p-10">
                      <div className="text-bone">
                        <div className="text-xs uppercase tracking-[0.25em] text-gold mb-3">In Office</div>
                        <div className="font-display text-3xl font-semibold leading-tight">Hon. (Engr.)<br/>Abdullahi Sesan<br/>Olowa</div>
                      </div>
                    </div>
                    <div className="absolute top-8 right-8">
                      <img src="/ibeju-lekki-logo.webp" alt="" className="w-20 h-20 opacity-80" />
                    </div>
                  </div>
                  <div className="absolute -bottom-6 -right-6 bg-gold text-ink px-6 py-4 rounded-xl shadow-xl">
                    <div className="text-xs uppercase tracking-wider mb-0.5">Conference 57</div>
              ...
              <Reveal delay={150} className="lg:col-span-7 order-1 lg:order-2">
                ...
                <p className="text-lg text-ink/70 leading-relaxed mb-8">
                  Guided by our 4 Cardinal Agenda — Infrastructure, Local Economy, Social Services, and Security — this administration is shaping Ibeju-Lekki into the New Lagos.
                </p>
                <div className="grid grid-cols-2 gap-6 mb-8">
                  {[
                    { n: '01', t: 'Infrastructure', d: 'Roads, schools, healthcare' },
                    { n: '02', t: 'Economy', d: 'Jobs & enterprise' },
                    { n: '03', t: 'Social Services', d: 'Education, health' },
                    { n: '04', t: 'Security', d: 'Safe, sustainable communities' },
                  ].map((item) => (
                    <div key={item.n} className="border-t border-forest/20 pt-4">
                      <div className="font-display text-gold text-sm mb-1">{item.n}</div>
                      <div className="font-semibold text-ink mb-1">{item.t}</div>
                      <div className="text-sm text-ink/60">{item.d}</div>
                    </div>
                  ))}
                </div>
                <a href="#" className="inline-flex items-center gap-2 text-forest font-medium link-hover">
                  Read full address →
                </a>
              </Reveal>
            </div>
                  ...
                  <article className="bg-ink/40 backdrop-blur rounded-2xl overflow-hidden border border-bone/5 hover:border-gold/30 transition-all h-full">
                    <div className="aspect-[16/10] bg-gradient-to-br from-moss to-ink relative overflow-hidden">
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="font-display text-[120px] font-bold text-bone/10 italic">LGDP</div>
                      </div>
        ...
        {/* BLOG / SPOTLIGHT SECTION - NEW */}
        <section className="py-32 bg-bone relative">
          <div className="max-w-7xl mx-auto px-6 lg:px-10">
            <Reveal>
              <div className="flex items-end justify-between mb-16 flex-wrap gap-6">
                <div>
                  ...
                  <Link href={`/news/${p.s}`} className="group block h-full">
                    <article className="h-full flex flex-col">
                      <div className="aspect-[4/5] rounded-2xl mb-6 relative overflow-hidden bg-gradient-to-br from-moss via-forest to-ink">
                        ...
                        <div className="absolute inset-0 bg-ink/0 group-hover:bg-ink/20 transition-all"></div>
                      </div>
                      ...
                      <div className="mt-auto inline-flex items-center gap-2 text-forest font-medium link-hover self-start">
                        Read story →
                      </div>
                    </article>
                  </Link>
            ...
            <Reveal>
              <div className="grid md:grid-cols-4 gap-8 md:gap-0">
                {[
                  ...
                  { n: '40+', l: 'Communities served' },
                  { n: '1990', l: 'Year established' },
                ].map((s, i) => (
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center">
            <Reveal>
              ...
              <p className="text-lg text-ink/60 leading-relaxed mb-10 max-w-xl mx-auto">
                Subscribe to receive news updates, emergency alerts, and community programs directly from the Office of the Executive Chairman.
              </p>
